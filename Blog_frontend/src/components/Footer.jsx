          ...
          <div className="w-full max-w-7xl mx-auto">
              <div className="grid w-full justify-between sm:flex md: grid-cols-1">
                  ...
                  <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-col-3 sm:gap-6">
                      ...
                      <Footer.LinkGroup col>
                          <Footer.Link
                              href='https://somethoughtsandfeelings2305.blogspot.com'
                              target='_blank'
                              rel='noopener noreferrer'
                          >Som thoughts and feelings
                      ...
                      <Footer.LinkGroup col>
                          <Footer.Link
                              href='https://github.com/Yuvrajkarmarkar'
                              target='_blank'
                              rel='noopener noreferrer'
                          >Github
              ...
              <Footer.Divider/>
                  <div className='w-full sm:flex sm:items-center sm:justify-between'>
                      <Footer.Copyright href='#' by="Yuvraj" year={new Date().getFullYear() } />
